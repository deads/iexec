...
=item B<--rlimit-cpu-hard> B<--rlimit-fsize-hard> B<--rlimit-data-hard> B<--rlimit-stack-hard> B<--rlimit-core-hard> B<--rlimit-rss-hard> B<--rlimit-nofile-hard> B<--rlimit-nproc-hard> B<--rlimit-memlock-hard> B<--rlimit-locks-hard> B<--rlimit-sigpending-hard> B<--rlimit-msgqueue-hard> B<--rlimit-nice-hard> B<--rlimit-rtprio-hard> v
...
=item B<--rlimit-cpu-soft> B<--rlimit-fsize-soft> B<--rlimit-data-soft> B<--rlimit-stack-soft> B<--rlimit-core-soft> B<--rlimit-rss-soft> B<--rlimit-nofile-soft> B<--rlimit-nproc-soft> B<--rlimit-memlock-soft> B<--rlimit-locks-soft> B<--rlimit-sigpending-soft> B<--rlimit-msgqueue-soft> B<--rlimit-nice-soft> B<--rlimit-rtprio-soft> v
